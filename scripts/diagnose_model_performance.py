...
def main():
    ...
    print(f"  Predictions at 0.5 threshold: {(y_train_proba >= 0.5).sum()} / {len(y_train_proba)}")
    ...
    print(f"  Predictions at 0.5 threshold: {(y_test_proba >= 0.5).sum()} / {len(y_test_proba)}")
