...
def test_model_variant():
    ...
    try:
        ...
        with open(project_root / "api_v1.py") as f:
            ...
            assert 'model_variant = os.getenv' in code, "MODEL_VARIANT not read from env"
...
def test_drift_summary_script():
    ...
    try:
        ...
        assert hasattr(generate_drift_summary, 'generate_drift_summary'), "Missing generate_drift_summary"
        assert hasattr(generate_drift_summary, 'extract_drift_summary'), "Missing extract_drift_summary"
        assert hasattr(generate_drift_summary, 'write_summary_markdown'), "Missing write_summary_markdown"
